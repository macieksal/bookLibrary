...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('bookLibraryBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('bookLibraryBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('bookLibraryBundle\Form\AuthorType', $author);
